...
const CommunityCardRotateScale = ({
  title,
  href,
  color = "bg-gray-100",
}: CommunityCardProps) => {
  return (
    <Link href={href} target="_blank">
      <div
        className={cn(
          "flex items-center justify-center rounded-full px-4 py-3 transition hover:-rotate-3 hover:scale-105",
          color,
        )}
      >
        {title}
...
export default CommunityCardsRotateScale;
